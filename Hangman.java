...
public class Hangman {
	...
	public String getCurrentGuessForDisplay(String currentGuess) {
		...
		for (int i = 0; i < currentGuess.length(); i++)
		{
			...
			result.append(currentGuess.charAt(i));
		}
	...
	public String updateCurrentGuess(String target, String guess, char letter) {
		...
		StringBuilder updatedString = new StringBuilder(guess);
		if (targetContains(target, letter))
		{
			int targetIndex = -1;
			targetIndex = target.indexOf(letter);
			updatedString.setCharAt(targetIndex, letter);
		}
